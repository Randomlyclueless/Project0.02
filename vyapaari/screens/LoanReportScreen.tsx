...
const LoanReportScreen = () => {
        ...
        <html>
          <body style="font-family: sans-serif; padding: 20px;">
            ...
            <ul>
              ...
              <li><b>Unique Vendors (Repeat Buyers):</b> ${stats.repeatCount}</li>
            </ul>
            <hr />
            <p>📌 <b>Trust Score:</b> ${stats.qrPercent > 60 ? "High" : "Moderate"}</p>
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.info}>This report includes the last 30 days of UPI and cash transaction data.</Text>
      <Button title="📤 Generate & Share Report" onPress={generateReport} disabled={loading} />
    </ScrollView>
  );
};
